...
class SurveyAnswersControllerTest < ActionController::TestCase
  ...
  test "should create survey_answer" do
    assert_difference('SurveyAnswer.count') do
      post :create, survey_answer: { answer: @survey_answer.answer, question: @survey_answer.question, vote_id: @survey_answer.vote_id }
    end
  ...
  test "should update survey_answer" do
    patch :update, id: @survey_answer, survey_answer: { answer: @survey_answer.answer, question: @survey_answer.question, vote_id: @survey_answer.vote_id }
    assert_redirected_to survey_answer_path(assigns(:survey_answer))
  end
