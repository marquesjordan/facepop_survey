...
class VisitorsControllerTest < ActionController::TestCase
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post :create, visitor: { age: @visitor.age, email: @visitor.email, gender: @visitor.gender, zip: @visitor.zip }
    end
  ...
  test "should update visitor" do
    patch :update, id: @visitor, visitor: { age: @visitor.age, email: @visitor.email, gender: @visitor.gender, zip: @visitor.zip }
    assert_redirected_to visitor_path(assigns(:visitor))
  end
